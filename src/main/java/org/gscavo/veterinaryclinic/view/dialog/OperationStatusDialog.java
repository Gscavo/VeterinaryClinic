 ...
 * @author gscavo
 */
public class OperationStatusDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        headerLabel.setText("Status da Operação");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OperationStatusDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OperationStatusDialog dialog = new OperationStatusDialog(new javax.swing.JFrame(), true, SystemOperationResult.objectNotFound());
